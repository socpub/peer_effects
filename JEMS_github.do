...
gen liveboth2=(livewithdad==1 & livewithmom==1)
replace liveboth2=. if livewithdad==. & livewithmom==.
replace liveboth2=. if livewithdad==. & livewithmom==.
replace liveboth2=0 if livewithdad==. & livewithmom==0
replace liveboth2=1 if livewithdad==. & livewithmom==1
replace liveboth2=0 if livewithdad==0 & livewithmom==.
replace liveboth2=1 if livewithdad==1 & livewithmom==.
...
label var mx_patedu_bal "Peer Parental Education"
...
foreach var of varlist female momcollege dadcollege liveboth2 age hhsize patedu_bal {
g miss_`var'=1
...
label var hispanicN2 "Hispanic"
label var miss_hispanicN2 "Missing(Hispanic)"
label var academic4 "Academic effort"
label var gpa "GPA"
label var femalei "Female"
label var agei "Age"
label var momcollegei "Mother college graduate"
label var dadcollegei "Father college graduate"
label var liveboth2i "Live with both parents"
label var hhsizei "HH size"
label var miss_female "Missing(Female)"
label var miss_age "Missing(Age)"
label var miss_momcollege "Missing(Mother college graduate)"
label var miss_dadcollege "Missing(Father college graduate)"
label var miss_liveboth2 "Missing(Live with both parents)"
label var miss_hhsize "Missing(HH size)"
...
femalei agei momcollegei dadcollegei liveboth2i hhsizei ///
miss_female miss_age miss_momcollege miss_dadcollege miss_liveboth2 miss_hhsize ///
sx_`env' ///
...
momcollege dadcollege liveboth2 hhsize
...
*** missing patterns
misschk academic4 gpa immigi age female whiteN blackN asianN americanN otherN hispanicN momcollege dadcollege liveboth2 hhsize 
...
female age momcollege dadcollege liveboth2 hhsize  ///
sx_`env' ///
, i(schoolidw1) fe robust cluster(schoolidw1)
